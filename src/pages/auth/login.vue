  ...
  <main class="px-5 pt-5 pb-[50px] md:grid md:grid-cols-2 md:p-[40px] min-h-screen md:gap-[20px]">
    <section class="flex justify-center items-center h-full">
      <div class="flex flex-col items-center gap-[30px] w-full max-w-[380px]">
        <form @submit="onClickHandler" class="flex flex-col gap-[40px] items-start w-full">
          <div>
    ...
    <section
      ...
      <NuxtImg class="rounded-lg border-2 border-neutral-500 hover:border-white transition-colors"
